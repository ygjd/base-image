...
This A1111 Stable Diffusion WebUI image is built and maintained by Vast.ai. It contains development libraries to enable building custom extensions and add-ons. Please see the associated documentation below for configuration details.
...
The `/workspace/` directory contains all of AUTOMATIC1111's code, models, extensions, and dependencies. To migrate to a different instance, simply copy this directory from one instance to another and then reboot. Everything will be preserved.
