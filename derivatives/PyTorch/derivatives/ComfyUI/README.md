...
The `/workspace/` directory contains all of ComfyUI's code, models, nodes, and dependencies. To migrate to a different instance, simply copy this directory from one instance to another and then reboot. Everything will be preserved.
